...
describe('range()', () => {
    it('should generates a sequence of integral numbers within a specified range', () => {
        ...
        assert.strictEqual(Enumerable.range(1, 10).skip(10).skip(10).firstOrDefault(null, 123), 123);
        assert.strictEqual(Enumerable.range(1, 10).skip(10).take(10).lastOrDefault(null, 123), 123);
        assert.strictEqual(Enumerable.range(1, 10).skip(10).elementAtOrDefault(0, 123), 123);
